...
import userEmpty from '../../assets/02/assets/img/user/unnamed.jpg';
                  ...
                  <div class="profile-content-left pt-5 pb-3 px-3 px-xl-5">
                    <div class="card text-center widget-profile px-0 border-0">
                      <div class="card-img mx-auto rounded-circle">
                        <img src={userEmpty} alt="user image" />
                      </div>
                      <div class="card-body">
                        <h4 class="py-2 text-dark">
                          {_.capitalize(user.id.name)}{' '}
                          {_.capitalize(user.id.surname)}
                        </h4>
                        <p>{user.id.email}</p>
                        {/* <a
                    ...
                    <div class="contact-info pt-4">
                      ...
                      <p>{user.id.phone ? user.id.phone : 'Not Provided'}</p>
                      <p class="text-dark font-weight-medium pt-4 mb-2">
                        Birthday
                      </p>
                      <p>
                        {user.id.birthday ? user.id.birthday : 'Not Provided'}
                      </p>
                      <p class="text-dark font-weight-medium pt-4 mb-2">
                        Social Profile
                      </p>
